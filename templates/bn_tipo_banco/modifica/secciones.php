...
<div class="col-md-3 secciones">
    ...
    <div class="col-md-12 int_secciones ">
        ...
        <div class="col-md-8">
            ...
            <?php include "templates/bn_tipo_banco/_base/links/2.php"; ?>
            <hr class="hr-menu-lateral">
            <?php include "templates/bn_tipo_banco/_base/links/3.php"; ?>
            <hr class="hr-menu-lateral">
            <?php include "templates/bn_tipo_banco/_base/links/4.php"; ?>
            <hr class="hr-menu-lateral">
            <?php include "templates/bn_tipo_banco/_base/links/5.php"; ?>
            <hr class="hr-menu-lateral">
            <?php include "templates/bn_tipo_banco/_base/links/6.php"; ?>
            <hr class="hr-menu-lateral">
            <?php include "templates/bn_tipo_banco/_base/links/7.php"; ?>
        </div>
