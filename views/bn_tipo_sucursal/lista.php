...
<?php include 'templates/bn_tipo_sucursal/lista/secciones.php'; ?>
                    ...
                    <div class="cont_tabla_sucursal  col-md-12">
                        <table class="table ">
                            ...
                            <?php foreach ($controlador->registros as $registro){?>
                                <tr>
                                    <th><?php echo $registro->bn_tipo_sucursal_id; ?></th>
                                    <th><?php echo $registro->bn_tipo_sucursal_codigo; ?></th>
                                    <th><?php echo $registro->bn_tipo_sucursal_descripcion; ?></th>
