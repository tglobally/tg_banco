...
<?php include 'templates/bn_layout/lista/secciones.php'; ?>
                    ...
                    <div class="cont_tabla_sucursal  col-md-12">
                        <table class="table ">
                            ...
                            <?php foreach ($controlador->registros as $registro){?>
                                <tr>
                                    <th><?php echo $registro->bn_layout_id; ?></th>
                                    <th><?php echo $registro->bn_layout_codigo; ?></th>
                                    <th><?php echo $registro->bn_layout_descripcion; ?></th>
