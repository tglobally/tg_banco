...
class controlador_bn_empleado extends \gamboamartin\banco\controllers\controlador_bn_empleado {

    public function __construct(PDO $link, stdClass $paths_conf = new stdClass()){

        $html_base = new html();
        parent::__construct( link: $link, html: $html_base, paths_conf: $paths_conf);
        $this->titulo_lista = 'Empleado';
