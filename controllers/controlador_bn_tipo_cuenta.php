...
class   controlador_bn_tipo_cuenta extends \gamboamartin\banco\controllers\controlador_bn_tipo_cuenta {
    ...
    public function __construct(PDO $link, stdClass $paths_conf = new stdClass()){
        ...
        $this->sidebar['lista']['titulo'] = "Tipos de Cuenta";
        $this->sidebar['lista']['menu'] = array(
            $this->menu_item(menu_item_titulo: "Alta", link: $this->link_alta,menu_seccion_active: true,
                menu_lateral_active: true));

        $this->sidebar['alta']['titulo'] = "Alta Tipo Cuenta";
        $this->sidebar['alta']['stepper_active'] = true;
        $this->sidebar['alta']['menu'] = array(
            $this->menu_item(menu_item_titulo: "Alta", link: $this->link_alta,menu_lateral_active: true));

        $this->sidebar['modifica']['titulo'] = "Modifica Tipo Cuenta";
        $this->sidebar['modifica']['stepper_active'] = true;
        $this->sidebar['modifica']['menu'] = array(
            $this->menu_item(menu_item_titulo: "Modifica", link: $this->link_alta,menu_lateral_active: true));

        $this->sidebar['cuentas']['titulo'] = "Tipo Cuenta";
        $this->sidebar['cuentas']['stepper_active'] = true;
        $this->sidebar['cuentas']['menu'] = array(
            $this->menu_item(menu_item_titulo: "Cuenta", link: $this->link_alta,menu_lateral_active: true));
